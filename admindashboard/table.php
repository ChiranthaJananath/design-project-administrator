                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="category">Here is a table for present  stock with specified data</p>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
											...
											<?php
					$sql = "SELECT food_id, category_name, item_name, food_amount, approve FROM foods";
					$result = mysqli_query($connection, $sql);
					if (mysqli_num_rows($result) > 0) {
						// output data of each row
						while($row = mysqli_fetch_assoc($result)) {
							//echo "id: " . $row["food_id"]. " - Name: " . $row["category_name"]. " " . $row["item_name"]. "<br>";
							echo "<tr><td>".$row["food_id"]."</td><td>".$row["category_name"]."</td><td>".$row["item_name"]."</td><td>".$row["food_amount"]."</td><td>".$row["approve"]."</td></tr>";
						}
					} else {
						echo "0 results";
					}
